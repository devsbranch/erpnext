...
frappe.tour['Buying Settings'] = [
	{
		...
		description: __("By default, the Supplier Name is set as per the Supplier Name entered. If you want Suppliers to be named by a <a href='#' target='_blank'>Naming Series</a> choose the 'Naming Series' option."),
	},
	{
